"""Desktop companion with HTTP toast - ~90 lines"""
import tkinter as tk, threading, random, os, sys
from http.server import HTTPServer, BaseHTTPRequestHandler
from urllib.parse import urlparse, parse_qs

PORT = 41983
GIF = os.path.join(os.path.dirname(os.path.abspath(sys.argv[0])), 'companion.gif')
...
class Companion:
    ...
    def show_toast(self, msg):
        """Show a speech bubble near the companion that auto-dismisses."""
    ...
    def _start_server(self):
        ...
        class H(BaseHTTPRequestHandler):
            def do_GET(self):
                ...
                msg = qs.get('msg', [''])[0]
                if msg:
                    companion.root.after(0, companion.show_toast, msg)
            ...
            def do_POST(self):
                ...
                if body:
                    companion.root.after(0, companion.show_toast, body)
                    self.send_response(200); self.end_headers(); self.wfile.write(b'ok')
                else:
