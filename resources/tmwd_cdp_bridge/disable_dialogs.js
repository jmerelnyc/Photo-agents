// Suppress alert / confirm / prompt so page-side scripts cannot block the
// extension's automation pipeline. Surfaces a non-blocking toast instead.
(function() {
  const _log = console.log.bind(console);
  function toast(type, msg) {
    _log('[Photo Agents] ' + type + ' suppressed:', msg);
    try {
